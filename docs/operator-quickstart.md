# Operator Quickstart — Community Freight Rail Transport

Shortest path from clone to a verified local dry-run for **ISIC 4912** (`cloud-itonami-isic-4912`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4912.git
cd cloud-itonami-isic-4912
```
...
- Blueprint governor key: `rail-freight-governor`
- Likely source path: `src/**/rail-freight-governor.cljc`
